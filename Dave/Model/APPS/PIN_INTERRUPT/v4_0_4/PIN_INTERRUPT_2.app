...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PIN_INTERRUPT" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2" description="The PIN_INTERRUPT APP invokes user interrupt handler in a response &#xA;to rising and/or falling edge event signal on a pin." mode="NOTSHARABLE" version="4.0.4" minDaveVersion="4.0.0" instanceLabel="PIN_INTERRUPT_2" appLabel="">
  ...
  <virtualSignals name="ogu_iout" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_iout" hwSignal="iout" hwResource="//@hwResources.3"/>
  ...
  <virtualSignals name="erunmi_in" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_erunmi_in" hwSignal="in" hwResource="//@hwResources.4"/>
  <virtualSignals name="iout" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_erunmi_out" hwSignal="out" hwResource="//@hwResources.4"/>
  <virtualSignals name="Pin_signal" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/__pin_vs_pin_interrupt_iopad" hwSignal="pin" hwResource="//@hwResources.5"/>
  <requiredApps URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/appres_cpu" requiredAppName="CPU_CTRL_XMC4" requiringMode="SHARABLE">
  ...
  <hwResources name="erunmi" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/hwres_scu_gcu_interrupt_erunmi" resourceGroupUri="peripheral/scu/*/gcu/interrupt/erunmi/*" mResGrpUri="peripheral/scu/*/gcu/interrupt/erunmi/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/SCU/SCU_0.dd#//@provided.24"/>
  </hwResources>
  <hwResources name="Pin" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/__pin_hwres_port_pin" resourceGroupUri="devicepackage/0/74" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_iout/http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_erunmi_in" systemDefined="true" sourceSignal="ogu_iout" targetSignal="erunmi_in" srcVirtualSignal="//@virtualSignals.4" targetVirtualSignal="//@virtualSignals.6"/>
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_erunmi_out/http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_signal" systemDefined="true" sourceSignal="iout" targetSignal="sr_node" srcVirtualSignal="//@virtualSignals.7" targetVirtualSignal="//@virtualSignals.5"/>
